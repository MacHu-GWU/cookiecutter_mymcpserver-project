# -*- coding: utf-8 -*-
#
# cookiecutter_mymcpserver documentation build configuration file, created by
...
import cookiecutter_mymcpserver as package
...
# Add data for Jinja2
try:
    from cookiecutter_mymcpserver.docs import doc_data
except:
    doc_data = dict()
